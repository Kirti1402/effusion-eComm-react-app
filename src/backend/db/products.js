...
export const products = [
  ...
  },
  {
    ...
    description: "GoSriKi Women's Rayon Kurta with Pants & Dupatta",
    url:"https://m.media-amazon.com/images/I/815QW8bkthL._UX569_.jpg",
    rating:3.4,
    price: 1500,
    discount:15,
    size:"S",
  ...
  {
    _id: uuid(),
    title: "A-Line Maxi Dress",
    description: "Lymio Women's Rayon A-Line Maxi Dress",
    url:"https://m.media-amazon.com/images/I/71YCvqdQn1L._UY679_.jpg",
    rating:4.9,
    price: 1020,
    discount:30,
    size:"M",
  ...
  {
    _id: uuid(),
    title: " Boy's Cotton Pocket T-Shirt",
    description: "Googogaaga Boy's T-Shirt With Short",
    url:"https://m.media-amazon.com/images/I/51KKESbET1L._UX522_.jpg",
    rating:1.2,
    price: 999,
    discount:10,
    size:"XL",
  ...
  {
    _id: uuid(),
    title: "Men's Cotton Printed ",
    description: "rytras Men's Cotton Peach Printed Straight Kurta",
    url:"https://m.media-amazon.com/images/I/71HIAY6U0+L._UY606_.jpg",
    rating:5,
    price: 1299,
    discount:45,
    size:"L",
